...
print(clasificar_chocolate(222))  ### si es palindromo 
print(clasificar_chocolate(111))  ### si es palindromo
print(clasificar_chocolate(505))  ### si es palindromo
